...
/**
  ...
  */
case class EnhancedForVariableNode(dataTypeNode: DataTypeNode, override val name: Option[String], range: Range) extends VariableLike {
    override def nodeType: AstNodeType = LocalVariableNodeType

    override def getValueType: Option[ValueType] = {
        dataTypeNode.getValueType
    }
